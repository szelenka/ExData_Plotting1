...
png("./plot4.png",width=480,height=480,units="px",pointsize=10)

# specify window parameters
par(pin=c(5,5), cex=1, cex.main=1.5, cex.axis=1.25, cex.lab=1.25, bg="transparent", mfrow=c(2,2), mar=c(5,4.5,3,2))
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=1, bty="n", col=c("black","red","blue"), border="black", cex=1.25)
