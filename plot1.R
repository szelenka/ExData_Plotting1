# szelenka 2014-06-05
# Plot1 for Programming Assignment in exdata-003
...
# read.table will load the entire file into memory, which is undero 200MB
...
par(pin=c(5,5), cex=0.75, cex.main=0.9, cex.axis=0.75, cex.lab=0.75, bg="transparent", mfrow=c(1,1), mar=c(5,5,3,2))
...
dev.copy(png,"./plot1.png",width=480,height=480,units="px",pointsize=10)
dev.off()